...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/andrelouw/SwiftStyleGuide/releases/download/0.0.6/swiftstyle.artifactbundle.zip",
      checksum: "81ce6f706d4f197f76930a5e995660997e55b0a0d2a5643dea9322f0c3d8397b"
    )
  ]
)
