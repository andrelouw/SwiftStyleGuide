...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/andrelouw/SwiftStyleGuide/releases/download/0.0.5/swiftstyle.artifactbundle.zip",
      checksum: "40ec777e477d94fef0f8f80e2c1f669a67cfcf70277932df672e50b8727d038b"
    )
  ]
)
